...
(def lib 'com.github.brianium/lemon-lime)
...
(defn jar [_]
  (b/write-pom {:class-dir class-dir
                ...
                :basis basis
                :src-dirs ["src"]
                :scm {:url                 "https://github.com/brianium/lemon-lime"
                      :connection          "scm:git:git://github.com/brianium/lemon-lime.git"
                      :developerConnection "scm:git:git://github.com/brianium/lemon-lime.git"
                      :tag                 "HEAD"}})
